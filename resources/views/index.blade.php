              ...
              <div class="clients pt-16">
                ...
                <div class="flex items-center">
                  <div class="mr-4 w-full py-3">
                    ...
                    <img src="{{asset ('img/empresas/DesWeb.png')}}" alt="UniversidadEvangelica" />
                    <a href="{{url('/form')}}" class="inline-flex items-center justify-center rounded-lg bg-primary py-4 px-6 text-center text-base font-normal text-white hover:bg-opacity-90 sm:px-10 lg:px-8 xl:px-10">
                      Aplica ahora
                    </a>
                  </div>
                  <div class="mr-4 w-full py-3">
          ...
          <div class="w-full px-4 lg:w-6/12">
            <div class="lg:ml-auto lg:text-right">
              <div class="relative z-10 inline-block pt-11 lg:pt-0">
                <img src="assets/images/hero/hero-image-01.png" alt="logo" class="max-w-full lg:ml-auto" />
