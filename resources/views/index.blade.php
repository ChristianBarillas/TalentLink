          ...
          <div class="w-full px-4 lg:w-5/12">
            <div class="hero-content">
              <h1 class="mb-3 text-4xl font-bold leading-snug text-dark sm:text-[42px] lg:text-[40px] xl:text-[42px]">
                ...
                Optimiza tus proceso administrativos.
              </h1>
              <p class="mb-8 max-w-[480px] text-base text-body-color">
              Genera informes, crea estados de cuentas para tus cliente con un solo click!
              </p>
              ...
              <div class="clients pt-16">
                ...
                <div class="flex items-center">
                  ...
                  <div class="mr-4 w-full py-3">
                    <img src="{{asset ('img/universidades/andresbello.png')}}" alt="graygrids" />
                  </div>
                  <div class="mr-4 w-full py-3">
          ...
          <div class="w-full px-4 lg:w-6/12">
            <div class="lg:ml-auto lg:text-right">
              <div class="relative z-10 inline-block pt-11 lg:pt-0">
                <img src="{{asset('img/nosotros/icon1.png')}}" alt="logo" class="max-w-full lg:ml-auto" />
          ...
          <div class="w-full px-4 lg:w-10/12">
            ...
            >
              <div class="absolute top-0 left-0 h-full w-full">
                <img
                  src="{{asset ('img/nosotros/founder.jpg')}}"
                  alt="image"
              ...
              >
                <a
                  ...
                  @click="videoOpen = true; videoSrc = 'https://www.youtube.com/embed/lFd6mP0QiLk' "
          ...
          <div class="w-full px-4">
            <div class="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
              ...
              <p class="text-base text-body-color">
                Mejorar la eficiencia de su negocio es nuestra prioridad.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <p class="text-body-color">
                Apoyo visual de los resultados de su empresa.
              </p>
            </div>
          </div>
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <p class="text-body-color">
                Nuestros sistemas estan encapsulado y encriptado para proteger su informacion.
              </p>
            </div>
          </div>
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <p class="text-body-color">
                Brindamos sistemas personalizado para nuestros clientes
              </p>
            </div>
          </div>
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <p class="text-body-color">
                Nuestro sistema es capaz de generar exel o pdf de acuerdo a sus necesidades
              </p>
            </div>
          </div>
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <p class="text-body-color">
                Nuestra herramienta se adapta a las necesidades de los clientes.
              </p>
            </div>
          </div>
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <p class="text-body-color">
              Disfrutamos trabajando con clientes exigentes, personas para quienes calidad, servicio, integridad y estética.
              </p>
            </div>
          </div>
        </div>
