          ...
          <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div class="mb-12 max-w-[570px] lg:mb-0">
              ...
              <p class="mb-9 text-base leading-relaxed text-body-color">
                Si desea personalizar aun más nuestro sistema para tu empresa, contactanos!
              </p>
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  <h4 class="mb-1 text-xl font-bold text-dark">Nuestra Ubicación</h4>
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  <h4 class="mb-1 text-xl font-bold text-dark">Numero telefónico</h4>
                  <p class="text-base text-body-color">(+503)60483336</p>
                </div>
              </div>
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  ...
                  <p class="text-base text-body-color">christianbarillasyt@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
