          ...
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-20">
              ...
              <p class="text-base text-body-color">
                La satisfacción de nuestros cliente es primero.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div class="mb-7">
                ...
                <p class="mb-1 text-base leading-loose text-body-color">
                  <del>API personalizada </del>
                </p>
                <p class="mb-1 text-base leading-loose text-body-color">
                  10 PDF (maximo) por día
                </p>
                <p class="mb-1 text-base leading-loose text-body-color">
                  10 Exel (maximo) por día
                </p>
                <p class="mb-1 text-base leading-loose text-body-color">
                  
                </p>
                <p class="mb-1 text-base leading-loose text-body-color">
                 <del>Soporte técnico  </del>
                </p>
                <br><br>
              </div>
              <a
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div class="mb-7">
                ...
                <p class="mb-1 text-base leading-loose text-body-color">
                 <del>Api personaliza </del> 
                </p>
                <p class="mb-1 text-base leading-loose text-body-color">
                  200 pdf (máximo) / day
                </p>
                <p class="mb-1 text-base leading-loose text-body-color">
                  200 exel (máximo) por dia
                </p>
                <p class="mb-1 text-base leading-loose text-body-color">
                  Soporte técnico
                </p>
